...
const About = () => {
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-white to-gray-50 dark:from-portfolio-dark dark:to-portfolio-dark relative">
          ...
          <div className="w-full md:w-2/5 order-2 md:order-1">
            <div className="relative">
              ...
              <div className="relative z-10">
                ...
                <div className="absolute top-4 left-4 z-20 p-3 bg-white/95 rounded-xl shadow-xl">
          ...
          <div className="w-full md:w-3/5 order-1 md:order-2">
            <div className="glass-card p-8 relative dark:bg-background/40">
              ...
              <div className="flex gap-4 flex-wrap">
                <a href="https://github.com/NodStan" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-5 py-2.5 bg-portfolio-dark text-white rounded-xl hover:bg-black transition-all duration-500 shadow-md">
