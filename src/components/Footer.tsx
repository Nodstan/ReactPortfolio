      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-8 md:mb-0">
            <a href="#" className="text-2xl font-bold text-white flex items-center">
              Nodstan<span className="text-portfolio-accent">.</span>
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <button 
              onClick={scrollToTop}
              className="bg-portfolio-primary p-3 rounded-lg hover:bg-portfolio-primary/80 transition-colors text-white"
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center">
          <p className="text-gray-400 flex items-center justify-center">
            &copy; {currentYear} Stanley Obitunwase. Made with All rights reserved.
          </p>
        </div>
      </div>
    </footer>
